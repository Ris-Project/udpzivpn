...
```bash
wget -q https://raw.githubusercontent.com/Ris-Project/udpzivpn/main/install.sh && chmod +x install.sh && ./install.sh
```
...
```bash
wget -q https://raw.githubusercontent.com/Ris-Project/udpzivpn/main/uninstall.sh && chmod +x uninstall.sh && ./uninstall.sh
```
